    ...
    <div className="py-12 sm:py-16 px-4">
      <div className="max-w-7xl mx-auto">
        <div className="text-center mb-10 sm:mb-12">
          <h1 className="text-3xl sm:text-4xl md:text-5xl font-bold mb-3 sm:mb-4">Our Activities</h1>
          <p className="text-base sm:text-xl text-gray-600 dark:text-gray-400">Choose your adventure on the Nile</p>
        </div>
